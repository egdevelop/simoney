...
<img style="position:absolute; width:80vw; transform: translate(10vw,18vw);" src="assets/img/boarding-card.png" alt="corak">
<div style="position:absolute; margin-top: 120vw; width:60vw; padding:5vw; color:#fff;">
    <h2 style="font-weight: 600;">Buat dompet digitalmu</h2>
    <br>
    <p style="font-size: 3vw; font-weight:400;">Dengan SIMONEY kamu bisa mengatur dompetmu secara digital</p>
</div>
...
<a href="index2.php" style="text-decoration: none; color:#fff;">
