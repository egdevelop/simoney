...
<body>
    <div class="page">
        <div class="card-mobile mb-5 nebeng-cuan">
            ...
            <br>
            <form action="server/nebeng-cuan.php" method="POST">
                <div class="mt-5">
                ...
                <input type="text" name="tujuan" class="input-nebeng" placeholder="Jalan ke rumah yaa biar ga muter...">
                <div class="mt-5">
                    <span style="font-weight:600; color: rgba(0, 8, 48, 0.47);" class="sub-text mb-5">Set Kendaraan</span>
                </div>
                <div class="flex">
                    <input type="text" name="kendaraan" class="input-nebeng-2" placeholder="Vario">
                    <input type="text" name="plat" class="input-nebeng-3" placeholder="Z 123 NA">
